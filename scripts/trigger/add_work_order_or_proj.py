            ...
            if not transfer:
                ...
                for other in all_other_wos:
                    ...
                    for otr in other_reals:
                        ...
                        if iftc not in [None,''] and iftc not in all_other_interms.keys():
                    ...
                    wods.extend(server.eval(wods_expr))
                ...
                blacklisted_keys = ['code','id','login','timestamp','attn','name','deliver_to','keywords','s_status','pipeline_code','work_order_deliverables_code','work_order_templ_code','__search_key__','search_type']
                ...
                for wod in wods:
                    ...
                    if wod_dtc not in [None,''] and wod_dtc not in all_other_delivs.keys():
                ...
                for passin_templ in passin_templs:
                    ...
                    if int_templ_code not in [None,''] and int_templ_code in all_other_interms.keys():
                    ...
                    elif del_templ_code not in [None,''] and del_templ_code in all_other_delivs.keys():
